...
export default function UserCalendarPage({ params }: { params: { username: string } }) {
  return (
      ...
      <section className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-100">
        <div className="flex items-center justify-between">
          <div>
            ...
            <h1 className="text-2xl font-semibold text-slate-900">{params.username}&apos;s calendar</h1>
          </div>
          <Link
        ...
        <p className="mt-3 text-sm text-slate-600">
          This calendar is isolated to {params.username}. Align your events API to require the JWT cookie before reading or writing.
        </p>
      </section>
