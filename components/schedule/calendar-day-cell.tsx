  ...
  return (
    ...
    >
      <div className="flex w-full flex-1 flex-col items-center justify-center gap-0.5 pb-0.5">
        ...
        {previewTitle && (
          <p className="max-w-[95%] overflow-hidden text-ellipsis text-center text-[9px] leading-tight text-[var(--color-text-muted)] group-hover:text-[var(--color-text-primary)]">
            {previewTitle}
          </p>
        )}
      </div>
