    ...
    <div className="card-surface space-y-3 p-3">
      <div className="flex flex-col gap-1.5 md:flex-row md:items-center md:justify-between">
        ...
        <div className="flex flex-col items-stretch gap-1.5 sm:flex-row sm:items-center sm:justify-end">
          <div className="flex items-center gap-1.5 rounded-full border border-[color:var(--color-border-subtle)] bg-[var(--color-bg-subtle)] px-2.5 py-1.5 shadow-sm">
            <button
      ...
      <div className={isFormOpen ? "grid grid-cols-1 gap-3 lg:grid-cols-[340px_1fr]" : "space-y-3"}>
        ...
        <div
          className={`space-y-3 md:space-y-0 md:grid md:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] md:items-start md:gap-3${
            isFormOpen ? "md:max-h-[660px] md:overflow-y-auto md:pr-1" : ""
          }`}
        >
          <div className="space-y-2.5 rounded-2xl border border-[color:var(--color-border-subtle)] bg-[var(--color-bg-card)] p-3 shadow-[0_12px_30px_rgba(0,0,0,0.06)]">
            <div className="grid grid-cols-7 text-center text-[11px] font-semibold uppercase tracking-wide text-[var(--color-text-muted)]">
            ...
            <div className="rounded-xl border border-[color:var(--color-border-subtle)]/70 bg-[color:var(--color-border-subtle)]/40 p-[3px] sm:p-2">
              <div className="grid grid-cols-7 gap-[3px] sm:gap-2 auto-rows-[minmax(56px,1fr)]">
          ...
          <div className="rounded-2xl border border-[color:var(--color-border-subtle)] bg-[var(--color-bg-subtle)] p-3 shadow-sm md:sticky md:top-1">
