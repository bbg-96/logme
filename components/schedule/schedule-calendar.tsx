...
export function ScheduleCalendar({ schedules, onDelete }: Props) {
  ...
  return (
    <div className="card-surface space-y-4 p-5">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex items-center gap-3 rounded-full border border-[color:var(--color-border-subtle)] bg-[var(--color-bg-subtle)] px-3 py-2">
          <button
          ...
          <div className="min-w-[180px] text-center text-sm font-semibold text-[var(--color-text-primary)]">{monthLabel}</div>
          <button
            onClick={() => changeMonth(1)}
            className="rounded-full px-2 py-1 text-lg font-semibold text-[var(--color-text-primary)] transition hover:bg-[var(--color-bg-card)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-indigo-500"
      ...
      <div className="grid grid-cols-1 gap-4 xl:grid-cols-[1.6fr_1fr]">
        ...
        <div className="rounded-xl border border-[color:var(--color-border-subtle)] bg-[var(--color-bg-subtle)] p-4 shadow-inner">
          <div className="flex items-start justify-between gap-2">
            ...
            <span className="rounded-full bg-[var(--color-bg-card)] px-3 py-1 text-xs font-semibold text-[var(--color-text-muted)]">
